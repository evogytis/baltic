...
ll.plot_tree(ax)
bt_utils.plot_node_bar(ax, node = ll.root, traitName = 'location.states', traitColourDict = state_colours, xyFxn = lambda k: (-0.5, 1.5), 
                       connectingCorner='lower middle', height = 2, width = 0.3, ec = 'k', orientation = 'vertical')
